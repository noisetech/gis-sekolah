        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="index.html" class="logo">
              <img src="{{ asset('fe/assets/images/logo.png') }}" alt="Chain App Dev">
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="{{ asset('fe/assets/images/slider-dec.png') }}" alt="">
              </div>
            </div>
          </div>
        </div>
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              <div class="client-content">
                                <img src="{{ asset('fe/assets/images/quote.png') }}" alt="">
                                <p>“Lorem ipsum dolor sit amet, consectetur adpiscing elit, sed do eismod tempor idunte ut labore et dolore magna aliqua darwin kengan
                                  lorem ipsum dolor sit amet, consectetur picing elit massive big blasta.”</p>
                              </div>
                              <div class="down-content">
                                <img src="{{ asset('fe/assets/images/client-image.jpg') }}" alt="">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="pricing-item-regular">
            ...
            <div class="icon">
              <img src="{{ asset('fe/assets/images/pricing-table-01.png') }}" alt="">
            </div>
            <ul>
      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          <div class="footer-widget">
            ...
            <div class="logo">
              <img src="{{ asset('fe/assets/images/white-logo.png') }}" alt="">
            </div>
